Run is guaranteed only in Linux-environment, other platforms are not considered. You need [gcc compiler](https://gcc.gnu.org/) and [address sanitizer](https://en.wikipedia.org/wiki/AddressSanitizer).
